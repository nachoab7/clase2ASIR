...
#~posible manera es con un include de todos los php anteriores (son arrays asociativos)
$arrayciudad=array(
    array("Vuelo"=>"Vueling-AE12","Ciudad"=>"Milán"),
    array("Vuelo"=>"Volotea-EA21","Ciudad"=>"Roma"),
    array("Vuelo"=>"Iberia-WE44","Ciudad"=>"Estambul"),
    ...
    array("Vuelo"=>"Ryanair-EL00","Ciudad"=>"Madrid"),
...
$arraypasajeros=array(
    ...
    array("Vuelo"=>"Vueling-ZK87","Personas"=>"77"),
